...
namespace NServiceBus.ObjectBuilder.CastleWindsor
{
    public class WindsorObjectBuilder : IContainer
    {
            ...
            this.Container.Kernel.Register(new IRegistration[1]
      {
        ...
        {
            ComponentModel componentModel = Enumerable.SingleOrDefault<ComponentModel>(Enumerable.Select<IHandler, ComponentModel>((IEnumerable<IHandler>)Container.Kernel.GetAssignableHandlers(component), (Func<IHandler, ComponentModel>)(x => x.ComponentModel)));
            ...
            componentModel.A(new PropertySet(property1, new DependencyModel(property, property1.PropertyType, false, true, value)));
        }
