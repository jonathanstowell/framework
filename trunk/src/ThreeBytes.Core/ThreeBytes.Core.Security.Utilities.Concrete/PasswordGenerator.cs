...
{
    // By Kevin Stewart http://www.codeproject.com/KB/cs/pwdgen.aspx
    public class PasswordGenerator : IPasswordGenerator
    {
        ...
        {
            return Generate(DefaultMinimum, DefaultMaximum);
        }

        public string Generate(int minimum, int maximum)
        {
