...
msbuild "..\ThreeBytes.Email.Messages\ThreeBytes.Email.Messages.Build\ThreeBytes.Email.Messages.msbuild"
msbuild "..\ThreeBytes.User.Messages\ThreeBytes.User.Messages.Build\ThreeBytes.User.Messages.msbuild"
msbuild "..\ThreeBytes.Logging.Messages\ThreeBytes.Logging.Messages.Build\ThreeBytes.Logging.Messages.msbuild"
msbuild "..\ThreeBytes.ProjectHollywood.Messages\ThreeBytes.ProjectHollywood.Messages.Build\ThreeBytes.ProjectHollywood.Messages.msbuild"
