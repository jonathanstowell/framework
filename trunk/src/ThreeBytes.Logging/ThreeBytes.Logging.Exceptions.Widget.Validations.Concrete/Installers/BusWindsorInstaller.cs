...
namespace ThreeBytes.Logging.Exceptions.Widget.Validations.Concrete.Installers
{
    public class BusWindsorInstaller : IBusWindsorRegistration
    {
        public void Install(IWindsorContainer container)
        {
            container.Register(
               ...
               AllTypes.FromThisAssembly().BasedOn<IExceptionWidgetExceptionValidatorResolver>().Configure(
                   component =>
                   {
