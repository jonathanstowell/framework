...
namespace ThreeBytes.User.Dashboard.RegistrationStatisticsYearly.Backend.MessageHandlers
{
    public class RegisteredUserExternalEventMessageHandler : IHandleMessages<IRegisteredUserExternalEventMessage>
    {
        ...
        public RegisteredUserExternalEventMessageHandler(IDashboardRegistrationStatisticsYearlyService service, IDashboardRegistrationStatisticsYearlyValidatorResolver validatorResolver)
        {
            if (service == null)
