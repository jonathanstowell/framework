...
namespace ThreeBytes.User.Dashboard.RegistrationStatisticsQuarterly.Backend.MessageHandlers
{
    public class RegisteredUserExternalEventMessageHandler : IHandleMessages<IRegisteredUserExternalEventMessage>
    {
        ...
        public RegisteredUserExternalEventMessageHandler(IDashboardRegistrationStatisticsQuarterlyService service, IProvideRegistrationStatisticsQuarterlyConfiguration configuration, IDashboardRegistrationStatisticsQuarterlyValidatorResolver validatorResolver)
        {
            if (service == null)
