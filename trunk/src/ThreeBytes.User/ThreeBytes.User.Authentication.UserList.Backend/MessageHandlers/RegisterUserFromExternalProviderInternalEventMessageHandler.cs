...
namespace ThreeBytes.User.Authentication.UserList.Backend.MessageHandlers
{
    public class RegisterUserFromExternalProviderInternalEventMessageHandler : IHandleMessages<IRegisterUserFromExternalProviderInternalEventMessage>
    {
        ...
        public RegisterUserFromExternalProviderInternalEventMessageHandler(IAuthenticationUserListUserService service, IAuthenticationUserListUserValidatorResolver validatorResolver)
        {
            if (service == null)
