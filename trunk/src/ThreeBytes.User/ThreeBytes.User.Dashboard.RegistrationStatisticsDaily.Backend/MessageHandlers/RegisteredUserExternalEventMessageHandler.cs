...
namespace ThreeBytes.User.Dashboard.RegistrationStatisticsDaily.Backend.MessageHandlers
{
    public class RegisteredUserExternalEventMessageHandler : IHandleMessages<IRegisteredUserExternalEventMessage>
    {
        ...
        public RegisteredUserExternalEventMessageHandler(IDashboardRegistrationStatisticsDailyService service, IDashboardRegistrationStatisticsDailyValidatorResolver validatorResolver)
        {
            if (service == null)
