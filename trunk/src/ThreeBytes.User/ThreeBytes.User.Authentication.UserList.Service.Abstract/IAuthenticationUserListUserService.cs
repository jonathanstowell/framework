...
namespace ThreeBytes.User.Authentication.UserList.Service.Abstract
{
    public interface IAuthenticationUserListUserService : IKeyedGenericService<AuthenticationUserListUser>
    {
