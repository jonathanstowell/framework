...
namespace ThreeBytes.User.Dashboard.RegistrationStatisticsMonthly.Backend.MessageHandlers
{
    public class RegisterUserFromExternalProviderExternalEventMessageHandler : IHandleMessages<IRegisterUserFromExternalProviderExternalEventMessage>
    {
        ...
        public RegisterUserFromExternalProviderExternalEventMessageHandler(IDashboardRegistrationStatisticsMonthlyService service, IDashboardRegistrationStatisticsMonthlyValidatorResolver validatorResolver)
        {
            if (service == null)
