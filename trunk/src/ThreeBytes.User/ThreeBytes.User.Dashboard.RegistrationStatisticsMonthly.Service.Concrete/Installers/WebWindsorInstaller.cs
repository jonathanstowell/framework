...
namespace ThreeBytes.User.Dashboard.RegistrationStatisticsMonthly.Service.Concrete.Installers
{
    public class WebWindsorInstaller : IWebWindsorRegistration
    {
        ...
        {
            container.Register(
                AllTypes.FromThisAssembly().BasedOn<IDashboardRegistrationStatisticsMonthlyService>().Configure(
                    component =>
                    {
