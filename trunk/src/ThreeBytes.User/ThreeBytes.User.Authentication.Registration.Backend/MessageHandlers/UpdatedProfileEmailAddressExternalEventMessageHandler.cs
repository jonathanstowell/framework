...
namespace ThreeBytes.User.Authentication.Registration.Backend.MessageHandlers
{
    public class UpdatedProfileEmailAddressExternalEventMessageHandler : IHandleMessages<IUpdatedProfileEmailAddressExternalEventMessage>
    {
        ...
        public UpdatedProfileEmailAddressExternalEventMessageHandler(IRegistrationUserService service, IRegistrationUserValidatorResolver validatorResolver)
        {
        ...
        public void Handle(IUpdatedProfileEmailAddressExternalEventMessage message)
        {
            ...
            RegistrationUser user = service.GetById(message.Id);
