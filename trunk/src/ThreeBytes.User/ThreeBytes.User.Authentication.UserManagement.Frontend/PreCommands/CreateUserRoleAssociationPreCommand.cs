...
{
    public class CreateUserRoleAssociationPreCommand : IPreCommand
    {
        ...
        public CreateUserRoleAssociationPreCommand(IAuthenticationUserManagementUserService userService, IAuthenticationUserManagementUserValidatorResolver validatorResolver, IAuthenticationUserManagementRoleService roleService)
        {
            if (userService == null)
