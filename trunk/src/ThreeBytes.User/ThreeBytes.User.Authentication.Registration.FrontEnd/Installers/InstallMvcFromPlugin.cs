...
namespace ThreeBytes.User.Authentication.Registration.FrontEnd.Installers
{
    public class InstallMvcFromPlugin : IWebWindsorRegistration
    {
        public void Install(IWindsorContainer container)
        {
            container.Register(
                ...
                AllTypes.FromThisAssembly().BasedOn<IRegisterRoutes>().Unless(x => x.IsAbstract).Configure(x => x.LifeStyle.Transient).WithService.FromInterface(),
