...
namespace ThreeBytes.User.Authentication.OAuth.Configuration.Concrete.Installers
{
    public class BusWindsorInstaller : IBusWindsorRegistration
    {
        ...
        {
            container.Register(
                AllTypes.FromThisAssembly().BasedOn<IProvideOAuthFoursquareConfiguration>().Configure(
                    component =>
                    {
