...
{
    public class CreateDashboardActiveUsersValidator : AbstractValidator<DashboardActiveUsers>
    {
        public CreateDashboardActiveUsersValidator(IProvideUserConfiguration provideUserConfiguration)
        {
