...
namespace ThreeBytes.User.Dashboard.ActiveUsers.Validations.Concrete.Installers
{
        ...
        public void Install(IWindsorContainer container)
        {
            container.Register(
               AllTypes
                   ...
                   .LifestyleTransient(),
               AllTypes.FromThisAssembly().BasedOn<IDashboardActiveUsersValidatorResolver>().Configure(
                   component =>
                   {
