...
namespace ThreeBytes.User.Authentication.UserManagement.Backend.MessageHandlers
{
    public class RegisterUserFromExternalProviderInternalEventMessageHandler : IHandleMessages<IRegisterUserFromExternalProviderInternalEventMessage>
    {
        ...
        public RegisterUserFromExternalProviderInternalEventMessageHandler(IAuthenticationUserManagementUserService service, IAuthenticationUserManagementUserValidatorResolver validatorResolver)
        {
            if (service == null)
