...
{
    public class CreatedUserRoleAssociationCommandMessageHandler : IHandleMessages<ICreateUserRoleAssociationCommandMessage>
    {
        ...
        public CreatedUserRoleAssociationCommandMessageHandler(IAuthenticationUserManagementUserService userService, IAuthenticationUserManagementRoleService roleService, IAuthenticationUserManagementUserValidatorResolver validatorResolver)
        {
            if (userService == null)
        ...
        public void Handle(ICreateUserRoleAssociationCommandMessage message)
        {
            if (message == null)
            ...
            Bus.PublishAndSendLocal<ICreatedUserRoleAssociationInternalEventMessage>(x =>
            {
                x.UserId = user.Id;
                x.RoleId = role.Id;
            });
