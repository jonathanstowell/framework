...
namespace ThreeBytes.SignalR.Infrastructure.ServiceBuildConvention
{
    public class CopyService : Task
    {
        ...
        public override bool Execute()
        {
            ...
            var suffixes = new[] { "Backend", "Configuration.Abstract", "Configuration.Concrete", "Data.Abstract", "Data.Concrete", "Entities.Abstract", "Entities.Concrete", "Entities.Mappings", "Frontend", "Messages", "Resources", "Jobs", "Service.Abstract", "Service.Concrete", "Validations.Abstract", "Validations.Concrete" };
        ...
        private IEnumerable<string> IterateDestinationsFor(string ac, string projectSuffix)
        {
            switch (projectSuffix)
            {
                ...
                case "Data.Abstract":
                case "Data.Concrete":
                case "Entities.Abstract":
                case "Entities.Concrete":
