...
namespace ThreeBytes.ProjectHollywood.Notification.Thespian.Frontend.Installers
{
    public class InstallMvcFromPlugin : IWebWindsorRegistration
    {
        public void Install(IWindsorContainer container)
        {
            container.Register(
                ...
                AllTypes.FromThisAssembly().BasedOn<IHub>().Unless(x => x.IsAbstract).Configure(x => x.LifeStyle.Transient).WithService.FromInterface(),
