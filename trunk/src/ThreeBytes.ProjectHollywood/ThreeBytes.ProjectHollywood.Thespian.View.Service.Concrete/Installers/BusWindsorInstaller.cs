...
namespace ThreeBytes.ProjectHollywood.Thespian.View.Service.Concrete.Installers
{
    public class BusWindsorInstaller : IBusWindsorRegistration
    {
        ...
        {
            container.Register(
                AllTypes.FromThisAssembly().BasedOn<IThespianViewThespianService>().Configure(
                    component =>
                    {
