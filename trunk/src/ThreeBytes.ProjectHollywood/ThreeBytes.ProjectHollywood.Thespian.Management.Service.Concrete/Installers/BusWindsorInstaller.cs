...
namespace ThreeBytes.ProjectHollywood.Thespian.Management.Service.Concrete.Installers
{
    public class BusWindsorInstaller : IBusWindsorRegistration
    {
        ...
        {
            container.Register(
                AllTypes.FromThisAssembly().BasedOn<IThespianManagementThespianService>().Configure(
                    component =>
                    {
