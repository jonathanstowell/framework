...
namespace ThreeBytes.ProjectHollywood.Thespian.List.Service.Concrete.Installers
{
    public class BusWindsorInstaller : IBusWindsorRegistration
    {
        ...
        {
            container.Register(
                AllTypes.FromThisAssembly().BasedOn<IThespianListThespianService>().Configure(
                    component =>
                    {
