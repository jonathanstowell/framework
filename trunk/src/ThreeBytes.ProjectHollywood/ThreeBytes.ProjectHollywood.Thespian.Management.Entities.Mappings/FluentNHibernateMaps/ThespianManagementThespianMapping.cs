...
namespace ThreeBytes.ProjectHollywood.Thespian.Management.Entities.Mappings.FluentNHibernateMaps
{
    public class ThespianManagementThespianMapping : ClassMap<ThespianManagementThespian>
    {
        public ThespianManagementThespianMapping()
        {
            Id(x => x.Id).GeneratedBy.GuidComb().Column("ThespianId");
            ...
            Table("ThespianManagementThespians");
        }
    }
}
