...
namespace ThreeBytes.ProjectHollywood.News.Management.Service.Concrete.Installers
{
    public class WebWindsorInstaller : IWebWindsorRegistration
    {
        ...
        {
            container.Register(
                AllTypes.FromThisAssembly().BasedOn<INewsManagementNewsArticleService>().Configure(
                    component =>
                    {
