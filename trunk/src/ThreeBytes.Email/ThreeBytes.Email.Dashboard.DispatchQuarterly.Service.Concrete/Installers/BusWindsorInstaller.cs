...
namespace ThreeBytes.Email.Dashboard.DispatchQuarterly.Service.Concrete.Installers
{
    public class BusWindsorInstaller : IBusWindsorRegistration
    {
        ...
        {
            container.Register(
                AllTypes.FromThisAssembly().BasedOn<IDispatchQuarterlyDashboardService>().Configure(
                    component =>
                    {
