...
{
    public class UpdateTemplateEmailContentsEventMessageHandler : IHandleMessages<ITemplateEmailContentsUpdatedExternalEventMessage>
    {
        ...
        public UpdateTemplateEmailContentsEventMessageHandler(IEmailDispatchManagementTemplateService service, IEmailDispatchManagementTemplateValidatorResolver validatorResolver)
        {
            if (service == null)
        ...
        public void Handle(ITemplateEmailContentsUpdatedExternalEventMessage message)
        {
            if (message == null)
