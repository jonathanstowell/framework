    ...
    public class InstallMvcFromPlugin : IWebWindsorRegistration
    {
        public void Install(IWindsorContainer container)
        {
            container.Register(
                ...
                AllTypes.FromThisAssembly().BasedOn<IRegisterRoutes>().LifestyleSingleton(),
                AllTypes.FromThisAssembly().BasedOn<IRegisterNavigation>().LifestyleSingleton(),
                AllTypes.FromThisAssembly().BasedOn<IPreCommand>().LifestyleTransient()
            );
        }
    }
}
