...
namespace ThreeBytes.Email.Template.List.Backend.MessageHandlers
{
    public class UpdateTemplateFromEmailAddressEventMessageHandler : IHandleMessages<ITemplateFromEmailAddressUpdatedInternalEventMessage>
    {
        ...
        public UpdateTemplateFromEmailAddressEventMessageHandler(IEmailTemplateListTemplateService service, IEmailTemplateListTemplateValidatorResolver validatorResolver)
        {
            if (service == null)
