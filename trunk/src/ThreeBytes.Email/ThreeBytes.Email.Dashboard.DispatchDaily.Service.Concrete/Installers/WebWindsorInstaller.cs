...
namespace ThreeBytes.Email.Dashboard.DispatchDaily.Service.Concrete.Installers
{
    public class WebWindsorInstaller : IWebWindsorRegistration
    {
        ...
        {
            container.Register(
                AllTypes.FromThisAssembly().BasedOn<IDispatchDailyDashboardService>().Configure(
                    component =>
                    {
