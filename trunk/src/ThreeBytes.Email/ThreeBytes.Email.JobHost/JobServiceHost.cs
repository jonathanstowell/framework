...
using ThreeBytes.Email.JobHost.Installers;
using Topshelf;

namespace ThreeBytes.Email.JobHost
{
    public static class JobServiceHost
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Host host = HostFactory.New(x =>
            {
                ...
                {
                    s.SetServiceName("ThreeBytes.Email.JobHost");
                ...
                x.SetDescription("ThreeBytes Email Quartz Service");
                x.SetDisplayName("ThreeBytes Email Quartz Service");
                x.SetServiceName("ThreeBytes Email Quartz Service");
            });
