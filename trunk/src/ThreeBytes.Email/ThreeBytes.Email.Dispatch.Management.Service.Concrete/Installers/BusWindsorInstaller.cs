...
namespace ThreeBytes.Email.Dispatch.Management.Service.Concrete.Installers
{
    public class BusWindsorInstaller : IBusWindsorRegistration
    {
        ...
        {
            container.Register(
                AllTypes.FromThisAssembly().BasedOn<IEmailDispatchManagementTemplateService>().Configure(
                    component =>
                    {
