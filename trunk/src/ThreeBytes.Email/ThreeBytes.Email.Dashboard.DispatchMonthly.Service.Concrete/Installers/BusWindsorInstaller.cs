...
namespace ThreeBytes.Email.Dashboard.DispatchMonthly.Service.Concrete.Installers
{
    public class BusWindsorInstaller : IBusWindsorRegistration
    {
        ...
        {
            container.Register(
                AllTypes.FromThisAssembly().BasedOn<IDispatchMonthlyDashboardService>().Configure(
                    component =>
                    {
